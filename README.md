...
Api to get daily ai papers

## Using

_Python package_: to add and install this package as a dependency of your project, run `poetry add ainewsbot`.

_Python CLI_: to view this app's CLI commands once it's installed, run `ainewsbot --help`.
